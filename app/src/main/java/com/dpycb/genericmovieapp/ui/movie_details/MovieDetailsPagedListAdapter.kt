...
class MovieDetailsPagedListAdapter(val context: Context): PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffUtil()) {
    //to determine which to show in recycler view
    val MOVIE_TYPE = 1
    val NETWORK_TYPE = 2
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == MOVIE_TYPE) {
            view = layoutInflater.inflate(R.layout.similar_movie_list_item, parent, false)
